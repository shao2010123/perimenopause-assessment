...
import { getQuestionById, getQuestionDisplayLabel } from '../data/questions.js';
import {
  generateHeroSection,
...
function buildDisplayAnswerJson(answers = {}) {
  return Object.fromEntries(
    Object.entries(answers).map(([questionId, value]) => [getQuestionDisplayLabel(questionId), value]),
  );
}
...
export function buildFeishuRecordFields(snapshot = {}) {
  ...
  return {
    ...
    完整答案JSON: toJson(buildDisplayAnswerJson(answers)),
