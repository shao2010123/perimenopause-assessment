...
function QuestionPage({
  ...
  return (
    <section className="mx-auto flex w-full max-w-3xl flex-col gap-3 sm:gap-4">
      ...
      <div className="surface-card sticky bottom-3 z-20 space-y-3 bg-[rgba(255,255,255,0.82)] pb-[max(1rem,env(safe-area-inset-bottom))] sm:static sm:space-y-4 sm:bg-[rgba(255,255,255,0.75)] sm:pb-4">
        {!canGoNext ? (
